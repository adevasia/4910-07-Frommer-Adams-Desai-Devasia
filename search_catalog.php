...
<table class="column">
  <tr>
  <td >
    <input type="text" name="t" placeholder="title" value="<?php session_start(); echo $_SESSION['items'][2]; ?>" />
    <?php 
...
<input type="text" name="p" placeholder="price of item" value="<?php echo $_SESSION['items'][3]; ?>" />
</form>
