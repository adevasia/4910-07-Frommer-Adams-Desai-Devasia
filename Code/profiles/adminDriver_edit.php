                ...
                <div class="col-lg-6 m-auto">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <form style="color: black" align="left" action="adminDriver_update.php?ID=<?php echo $UserID ?>" method="post">
                                ...
                                <button class="btn btn-primary" name="updateAD">Update</button>
                            </form>
